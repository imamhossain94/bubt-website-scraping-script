...
def uploadImageFile(fileName, stringFile):
    try:
        ...
        im.save('faculties/cse/%s_%d.png'%(fileName, randId), 'PNG')
        bucket = storage.bucket()
        blob = bucket.blob('faculties/cse/%s_%d.png'%(fileName, randId))
        blob.upload_from_filename('faculties/cse/%s_%d.png'%(fileName, randId))
        blob.make_public()
...
getCSEFaculties("/home/faculty_member/cse")
